...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // =========================================================================
  // 17. VIDEO SHOWCASE INTERACTIVE PLAY CONTROLLER
  // =========================================================================
  const videoPoster = document.getElementById('game-video-poster') || document.querySelector('.video-poster-overlay');
  const videoBox = document.getElementById('game-video-box') || document.querySelector('.video-player-box');
  const videoIframe = document.getElementById('game-video-iframe') || (videoBox ? videoBox.querySelector('iframe') : null);
