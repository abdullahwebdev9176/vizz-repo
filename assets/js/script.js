...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // =========================================================================
  // VIDEO SHOWCASE INTERACTIVE PLAY CONTROLLER
  // =========================================================================
  const videoPoster = document.getElementById('index-video-poster') || document.querySelector('.video-poster-overlay');
  const videoBox = document.getElementById('index-video-box') || document.querySelector('.video-player-box');
  const videoIframe = document.getElementById('index-video-iframe') || (videoBox ? videoBox.querySelector('iframe') : null);
